...
CREATE TABLE `khachhang` (
  ...
  `HoKH` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `nhasanxuat` (
  ...
  `TenCongTyNSX` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `DiaChiNSX` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `DienThoaiNSX` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`MaNSX`)
...
CREATE TABLE `sanpham` (
  ...
  `DonviTinh` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `sanpham` VALUES ('10','Đá xây',900,346000,'m3',NULL,'\\Images\\DaXay.jpg',3,NULL),('11','Cát san lấp',800,126000,'m3',NULL,'\\Images\\CatSanLap.jpg',2,NULL),('12','Thép phi 10 ',250,195000,'cây','cây 12m','\\Images\\SatPhi10.jpg',5,NULL),('13','Thép phi 15 ',150,215000,'cây','cây 12m','\\Images\\SatPhi15.png',5,NULL),('14','Xi măng Hocim',600,86900,'bao','bao 50kg','',4,3),('2','Gạch Phước Thành',2000,1080,'vien',NULL,'\\Images\\GachPhuocThanh.jpg',1,1),('3','Xi măng Hà Tiên',400,84700,'bao','bao 50kg','	\\Images\\XiMangHaTien.jpg',4,3),('4','Xi măng Thăng Long',500,77000,'bao','bao 50kg','	\\Images\\XiMangThangLong.jpg',4,3),('5','Gạch men',1000,261000,'m2','kích thước 40x40','\\Images\\GachMen.jpg',1,2),('6','Bột Jotun',300,396000,'bao','bao 40kg','\\Images\\BotJotun.png',6,3),('7','Gạch Thành Tâm',1500,1100,'vien',NULL,'\\Images\\GachThanhTam.jpg',1,NULL),('8','Bột Dulux',200,436000,'bao','bao 40kg','\\Images\\BotDulux.jpg',6,3),('9','Cát xây',700,355000,'m3',NULL,'\\Images\\CatXay.jpg',2,NULL);
...
-- Dump completed on 2021-03-26 16:22:20
