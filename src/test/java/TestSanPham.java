...
public class TestSanPham {
   ...
   public void TestXoaSanPham2() throws SQLException{ 
    ...
    {   
        sanpham p = new sanpham(23,"21",1,1.0,"1","1",1,1);
        Utils.addSanPhamTest(p);
        assertTrue(Utils.themSanPhamTest(23));
    ...
    {   
        sanpham p = new sanpham(24,"22",1,1.0,"1","1",1,1);
        Utils.addSanPhamTest(p);
        assertTrue(Utils.themSanPhamTest(24));
    ...
    {   
        sanpham p = new sanpham(21,"1",1,1.0,"1","1",1,1);
        Utils.addSanPhamTest(p);
    ...
    {   
        sanpham p = new sanpham(35,"1",1,1.0,"1","1",1,1);
        Utils.addSanPhamTest(p);
        assertTrue(Utils.themSanPhamTest(35));
